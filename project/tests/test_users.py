...
class TestUserService(BaseTestCase):
	...
	def test_add_user_invalid_json_keys(self):
		""" Ensure error is thrown if the JSON object does not have a user key. """
		with self.client:
			response = self.client.post(
				'/users',
	...
	def test_all_users(self):
		...
		with self.client:
			...
			self.assertIn('daniel', data['data']['users'][2]['username'])
			self.assertIn('daniel@gmail.com', data['data']['users'][2]['email'])
			self.assertIn('success', data['status'])
